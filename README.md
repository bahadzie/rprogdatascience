...
2. Install all of the packages listed in the [_R_package_list.txt](https://github.com/bahadzie/rprogdatascience/blob/master/manuscript/_R_package_list.txt) file.
